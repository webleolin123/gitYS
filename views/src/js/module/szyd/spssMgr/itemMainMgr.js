    ...
    var eventHandle={
        ...
        initSearch: function(){
            ...
            $("#btnSearch").on("click", function(obj){
                ...
                var sURL = baseUrl + "sasszrule/statistics/selectTiolItemClassLists";
        ...
        initEchart: function(){
            var sURL1 = baseUrl + "sasszrule/statistics/selectTiolItemClassList";   //事项清单汇总
            var sURL2 = baseUrl + "sasszrule/statistics/selectItemLawList";     //涉及法律审核情况
            var sURL3 = baseUrl + "sasszrule/statistics/selectTiolItemTypeList";    //事项清单决策分布
        ...
        initCol: function(){
            ...
            resultCols[0].push({field:"itemCount", title:"事项总数"});
