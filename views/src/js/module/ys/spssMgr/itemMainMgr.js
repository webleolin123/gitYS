    ...
    var eventHandle = {
        ...
        initSearch: function () {
            ...
            $("#btnSearch").on("click", function (obj) {
                ...
                var sURL = baseUrl + "catalog/tiolBillType/selectTiolBillTypeCountList";
        ...
        initEchart: function () {
            var sURL1 = baseUrl + "catalog/tiolBillType/selectBillTypeListe";   //事项清单汇总
            var sURL2 = baseUrl + "catalog/tiolBillType/selectBillTypeLawList";     //涉及法律审核情况
            var sURL3 = baseUrl + "catalog/tiolBillType/selectBillTypeMetList";    //事项清单决策分布
        ...
        getCol: function (columns) {
            ...
            if (columns.length > 0) {
                $.map(columns, function (column) {
                    ...
                    data.field = column.code;
                    data.title = column.name;
                    data.minWidth = 35 * column.name.length;
                    // data.minWidth = 1 * column.name.length;
                    data.align = "center";
                    data.templet = function (rowDta) {
                        return '<span class="tableListLayer a-link" data-seId="' + rowDta.seId + '"  data-billType="' + column.code + '">' + (rowDta[column.code]) + '</span>'
                    };
                    cols[0].push(data);
                });
            }
                ...
                mainTable = table.render(common.tableInitParams({
                    ...
                    cols: cols,
                        ...
                        $('.slideIcon').off().on('click', function () {
                            ...
                            var param = {
                                seId: data.id, isIncludeChild: tableParam.isIncludeChild, pId: data.id,
